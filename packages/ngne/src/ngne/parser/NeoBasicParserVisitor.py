...
class NeoBasicParserVisitor(ParseTreeVisitor):
    ...
    def visitBitExclusiveDisjunctionOperator(self, ctx:NeoBasicParser.BitExclusiveDisjunctionOperatorContext):
        return self.visitChildren(ctx)
    ...
    def visitMultipleAssignmentOperator(self, ctx:NeoBasicParser.MultipleAssignmentOperatorContext):
        return self.visitChildren(ctx)
