...
class NeoBasicParserListener(ParseTreeListener):
    ...
    def enterBitExclusiveDisjunctionOperator(self, ctx:NeoBasicParser.BitExclusiveDisjunctionOperatorContext):
        pass

    # Exit a parse tree produced by NeoBasicParser#bitExclusiveDisjunctionOperator.
    def exitBitExclusiveDisjunctionOperator(self, ctx:NeoBasicParser.BitExclusiveDisjunctionOperatorContext):
        pass
    ...
    def enterMultipleAssignmentOperator(self, ctx:NeoBasicParser.MultipleAssignmentOperatorContext):
        pass
